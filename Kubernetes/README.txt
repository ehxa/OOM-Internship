How to use and configure workers for running WRF
...
9. Configure ssh access to the other pods in wrf-arm-worker0:
a. kubectl logs wrf-arm-master
...
10. Copy hosts.txt to the directory used in 1.a.
